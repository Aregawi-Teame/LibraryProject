...
public class LibrarySystem extends JFrame implements MessageableWindow {
	...
	JPanel cards;
	public static JTextArea statusBar = new JTextArea("Library Management System");
	LoginPanel lp;
	AllMemberIds abip;
	AllBooksID abid;
	...
	ListItem checkoutRecords = new ListItem("Print Checkout Records(By MEMBER)", false);
	ListItem bookStatus = new ListItem("Check Overdue Status (By ISBN)", false);
	...
	public LibrarySystem() {
		...
		innerPane.setDividerLocation(260);
